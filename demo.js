...
const DEFAULT_SCHEDULE = [
  { name: 'AEW Dynamite', type: 'Weekly TV', howOften: 'Weekly', day: 'Wednesday', notes: '' },
  { name: 'AEW Collision', type: 'Weekly TV', howOften: 'Weekly', day: 'Saturday', notes: '' },
  { name: 'WWE Raw', type: 'Weekly TV', howOften: 'Weekly', day: 'Monday', notes: '' },
  { name: 'WWE SmackDown', type: 'Weekly TV', howOften: 'Weekly', day: 'Friday', notes: '' }
];
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('schedule-add')?.addEventListener('click', () => {
    ...
    data.schedule.push({ name: 'New show', type: 'Weekly TV', howOften: 'Weekly', day: 'Wednesday', notes: '' });
    renderScheduleEditor();
  });
